<?php
/**
 * Class UltimaKit_Module_Change_Howdy_Admin_In_Admin_Bar
 *
 * @since 1.0.0
 * @package    UltimaKit
 */
 ...
 * @since 1.0.0
 */
class UltimaKit_Module_Change_Howdy_Admin_In_Admin_Bar extends UltimaKit_Module_Manager {
	/**
	 * @var string
	 */
	protected $ID = 'ultimakit_module_change_howdy_admin_bar';
	 ...
	 * @var string
	 */
	protected $read_more_link = 'change-howdy-message-in-admin-bar-in-wordpress';
	...
	public function __construct() {
		$this->name        = __( 'Change “Howdy Admin” in Admin Bar', 'ultimakit-for-wp' );
		$this->description = __( 'Customize the "Howdy" message in the admin bar.', 'ultimakit-for-wp' );
	...
	public function add_modal() {
		...
		$arguments['title'] = __( 'Change “Howdy Admin” in Admin Bar', 'ultimakit-for-wp' );

		$arguments['fields'] = array(
			'change_howdy_msg' => array(
				'type'  => 'text',
				'label' => __( 'Message', 'ultimakit-for-wp' ),
				'value' => $this->getModuleSettings( $this->ID, 'change_howdy_msg' ),
				'desc'  => __( 'Default text is = Howdy, ', 'ultimakit-for-wp' ),
			),
		);
	...
	public function snippet_replace_howdy( $wp_admin_bar ) {
		...
		$wp_admin_bar->add_node(
			array(
				'id'    => 'my-account',
				'title' => str_replace( 'Howdy,', $this->getModuleSettings( $this->ID, 'change_howdy_msg' ), $my_account->title ),
			)
		);
	}
}
