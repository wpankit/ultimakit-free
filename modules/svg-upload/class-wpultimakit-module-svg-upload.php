...
class UltimaKit_Module_SVG_Upload extends UltimaKit_Module_Manager {
	...
	protected function ultimakit_scrub_svg_node( $element ) {
		static $allowed_elements = array(
			'svg', 'g', 'defs', 'symbol', 'use', 'title', 'desc', 'metadata', 'switch', 'a', 'style',
			...
			'femerge', 'femergenode', 'femorphology', 'fedropshadow', 'feturbulence',
			'fedisplacementmap', 'fetile', 'fespecularlighting', 'fediffuselighting',
			'fepointlight', 'fedistantlight', 'fespotlight', 'fecomponenttransfer',
